...
// ---- Types ----
interface GroupMember { name: string; block: string; avatar: string; color: string; interests?: string[]; languages?: string[]; }
interface Group {
  id: number;
  name: string;
  emoji: string;
...
const GROUPS: Group[] = [
  {
    ...
    members: 24,
    membersList: [
      { name: 'Alex Lim', block: 'Blk 445', avatar: 'AL', color: '#FF6B47', interests: ['Fitness & Sports','Cooking & Baking'], languages: ['English','Chinese'] },
      { name: 'Ben Tan', block: 'Blk 447', avatar: 'BT', color: '#7C3AED', interests: ['Gaming','Technology & Digital Skills'], languages: ['English','Chinese'] },
      { name: 'Diana Mak', block: 'Blk 445', avatar: 'DM', color: '#059669', interests: ['Gardening & Plants','Yoga & Mindfulness'], languages: ['English','Chinese'] },
      { name: 'Eli Ng', block: 'Blk 449', avatar: 'EN', color: '#0891B2', interests: ['Community Volunteering','Arts & Crafts'], languages: ['English'] },
      { name: 'Gary Koh', block: 'Blk 450', avatar: 'GK', color: '#EA580C', interests: ['DIY & Home Improvement','Technology & Digital Skills'], languages: ['English','Chinese'] },
      { name: 'Hannah Lee', block: 'Blk 445', avatar: 'HL', color: '#475569', interests: ['Photography','Outdoor Activities'], languages: ['English','Chinese'] },
    ],
  ...
  },
  {
    ...
    members: 18,
    membersList: [
      { name: 'Clara Soh', block: 'Blk 448', avatar: 'CS', color: '#D97706', interests: ['Cooking & Baking','Gardening & Plants'], languages: ['English','Malay'] },
      { name: 'Fiona Raj', block: 'Blk 446', avatar: 'FR', color: '#DB2777', interests: ['Music & Performing Arts','Dance'], languages: ['English','Tamil'] },
      { name: 'Ivan Wong', block: 'Blk 451', avatar: 'IW', color: '#0D9488', interests: ['Language Learning','Cultural Heritage & Festivals'], languages: ['English','Malay','Japanese'] },
      { name: 'Jasmine Yap', block: 'Blk 452', avatar: 'JY', color: '#BE185D', interests: ['Fashion & Beauty','Arts & Crafts'], languages: ['English','Chinese'] },
      { name: 'Hannah Lee', block: 'Blk 445', avatar: 'HL', color: '#475569', interests: ['Photography','Outdoor Activities'], languages: ['English','Chinese'] },
    ],
  ...
  },
  {
    ...
    members: 42,
    membersList: [
      { name: 'Mr Tan Ah Kow', block: 'Blk 445', avatar: 'TA', color: '#0891B2', interests: ['Yoga & Mindfulness','Community Volunteering'], languages: ['English','Chinese'] },
      { name: 'Mdm Wong Li Hua', block: 'Blk 447', avatar: 'WL', color: '#DB2777', interests: ['Yoga & Mindfulness','Cooking & Baking'], languages: ['Chinese','English'] },
      { name: 'Mr Lim Beng Huat', block: 'Blk 448', avatar: 'LB', color: '#059669', interests: ['Fitness & Sports','Community Volunteering'], languages: ['English','Chinese'] },
      { name: 'Mdm Chan Siew Eng', block: 'Blk 445', avatar: 'CS', color: '#EA580C', interests: ['Cooking & Baking','Gardening & Plants'], languages: ['Chinese','English'] },
      { name: 'Mr Goh Teck Seng', block: 'Blk 449', avatar: 'GT', color: '#7C3AED', interests: ['Community Volunteering','Cultural Heritage & Festivals'], languages: ['Chinese','English'] },
    ],
  ...
  },
  {
    ...
    members: 28,
    membersList: [
      { name: 'Sarah Chen', block: 'Blk 447', avatar: 'SC', color: '#DB2777', interests: ['Babies & Kids','Cooking & Baking','Community Volunteering'], languages: ['English','Chinese'] },
      { name: 'Marcus Lim', block: 'Blk 448', avatar: 'ML', color: '#7C3AED', interests: ['Babies & Kids','Outdoor Activities','Fitness & Sports'], languages: ['English','Chinese'] },
      { name: 'Priya Nair', block: 'Blk 449', avatar: 'PN', color: '#D97706', interests: ['Babies & Kids','Yoga & Mindfulness','Community Volunteering'], languages: ['English','Tamil'] },
      { name: 'Darren Yeo', block: 'Blk 446', avatar: 'DY', color: '#059669', interests: ['Babies & Kids','Technology & Digital Skills','Gaming'], languages: ['English','Chinese'] },
      { name: 'Kelly Tan', block: 'Blk 450', avatar: 'KT', color: '#EA580C', interests: ['Babies & Kids','Arts & Crafts','Cooking & Baking'], languages: ['English'] },
      { name: 'James Ho', block: 'Blk 445', avatar: 'JH', color: '#0891B2', interests: ['Babies & Kids','DIY & Home Improvement','Outdoor Activities'], languages: ['English','Chinese'] },
    ],
  ...
  },
  {
    ...
    membersList: [
      { name: 'Hannah Lee', block: 'Blk 445', avatar: 'HL', color: '#475569', interests: ['Photography','Outdoor Activities'], languages: ['English','Chinese'] },
      { name: 'Ryan Chew', block: 'Blk 451', avatar: 'RC', color: '#EA580C', interests: ['Photography','Outdoor Activities','Arts & Crafts'], languages: ['English','Chinese'] },
      { name: 'Mei Lin Tan', block: 'Blk 452', avatar: 'MT', color: '#BE185D', interests: ['Photography','Arts & Crafts','Dance'], languages: ['English','Chinese'] },
      { name: 'Ahmad Razi', block: 'Blk 447', avatar: 'AR', color: '#0D9488', interests: ['Photography','Music & Performing Arts','Community Volunteering'], languages: ['English','Malay'] },
    ],
  ...
  },
  {
    ...
    membersList: [
      { name: 'Jasmine Yap', block: 'Blk 452', avatar: 'JY', color: '#BE185D', interests: ['Fashion & Beauty','Arts & Crafts'], languages: ['English','Chinese'] },
      { name: 'Ivan Wong', block: 'Blk 451', avatar: 'IW', color: '#0D9488', interests: ['Language Learning','Cultural Heritage & Festivals'], languages: ['English','Malay','Japanese'] },
      { name: 'Nurul Ain', block: 'Blk 446', avatar: 'NA', color: '#7C3AED', interests: ['Reading & Books','Community Volunteering','Cooking & Baking'], languages: ['English','Malay'] },
      { name: 'Wei Jie Ong', block: 'Blk 448', avatar: 'WJ', color: '#059669', interests: ['Reading & Books','Technology & Digital Skills','Gaming'], languages: ['English','Chinese'] },
      { name: 'Celine Koh', block: 'Blk 450', avatar: 'CK', color: '#D97706', interests: ['Reading & Books','Arts & Crafts','Cultural Heritage & Festivals'], languages: ['English','Chinese'] },
    ],

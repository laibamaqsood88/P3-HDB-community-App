...
const ITEMS_AND_SERVICES = [
  ...
  { id: 107, itemType: 'item' as const, name: 'Yoga Mat', condition: 'like new', distance: '0.4 km away', postedTime: '1 week ago', price: '$10', category: 'Sports & Outdoors', brand: 'Lululemon', verified: true, description: 'Lululemon yoga mat, barely used — only 3 sessions. Non-slip surface, comes with strap.', collectionAddress: 'Blk 446 Ang Mo Kio Ave 10, #08-05, Singapore 560446', collectionDistance: '0.4 km away', image: yogaMatImg, seller: { name: 'Sarah', avatarColor: '#A855F7', rating: 5.0, reviews: 3 } },
  ...
  { id: 203, itemType: 'service' as const, name: 'Primary Math Tutoring', rate: 'Free', distance: '0.3 km away', serviceAddress: 'Blk 445 Ang Mo Kio Ave 10, Singapore 560445', postedTime: '3 days ago', category: 'Tutoring & Coaching', availability: 'Weekday evenings', verified: true, trust: false, trustNote: '', description: 'Retired primary school teacher offering free maths help for P3–P6 students. 25 years of teaching experience. Small group sessions available.', responseTime: 'Replies within a day', completedServices: 34, yearsExperience: 25, image: primaryMathImg, provider: { name: 'Mr Tan', avatarColor: '#3B82F6', rating: 5.0, reviews: 22 } },
